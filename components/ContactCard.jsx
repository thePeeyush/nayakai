...
const ContactCard = () => {
  ...
  return (
    <div onClick={() => setOpen(!open)} className={`flex flex-col bg-white rounded-md ${open ? 'shadow-md' : 'shadow-none'} my-2 max-w-[350px] w-full overflow-hidden`}>
        <div className={`flex flex-row items-center gap-4 p-3 ${open ? 'bg-red-50' : 'bg-slate-50'}`}>
